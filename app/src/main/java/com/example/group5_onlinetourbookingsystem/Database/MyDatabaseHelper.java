...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    // Tăng version database để bao gồm cột password
    ...
    // Tạo bảng Users (bao gồm cột password)
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // Xoá hết các bảng cũ và tạo lại (chỉ dùng trong giai đoạn phát triển)
    ...
    public void addTour(String name, String destination, double price, int duration, String imagePath, int categoryId) {
        ...
        values.put(COLUMN_TOUR_CATEGORY_NAME, categoryName);
    ...
    // Phương thức thêm tour với danh mục (nếu cần)
    public void addTourWithCategory(String name, String destination, double price, int duration, String imagePath, String categoryName) {
        ...
        tourValues.put(COLUMN_TOUR_CATEGORY_NAME, categoryName);
    ...
    // Phương thức thêm người dùng (Sign Up)
    public long addUser(String name, String email, String phone, String password, String image) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    // Phương thức kiểm tra đăng nhập: trả về 1 nếu đúng, 0 nếu sai mật khẩu, -1 nếu tài khoản không tồn tại
